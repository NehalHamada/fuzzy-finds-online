...
export const SHOPIFY_STORE_PERMANENT_DOMAIN = 'fuzzy-finds-online-iv6sq.myshopify.com';
export const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
export const SHOPIFY_STOREFRONT_TOKEN = '7dce3d8415a4b2005e5345f5d782921e';
